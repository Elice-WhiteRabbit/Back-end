...
router.patch('/:id', userValidation.patchUser, auth, asyncHandler(userController.modifyUser));
...
router.post('/password', userValidation.checkUser, asyncHandler(userController.sendCode));
router.post('/password/code', userValidation.checkCode, asyncHandler(userController.checkCode));
router.post('/password/reset', userValidation.passwordReset, asyncHandler(userController.resetPassword));
...
router.get('/followings/number/:id', asyncHandler(userController.findAllFollowNumber));
